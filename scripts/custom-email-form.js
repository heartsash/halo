...
var pagesWithCustomButtons = [
	// homepage
	{
		pageId: "collection-589622f4d1758ebabec92264",
		formId: "block-yui_3_17_2_2_1486256658221_46104"
	},
	//PMF page
	{
		pageId: "collection-58c5b29d893fc021adf872bc",
		formId: "block-yui_3_17_2_3_1489523619726_9461"
	},
	//investors page
	{
		pageId: "collection-58d2b4a4a5790a8c5c0c0c4c",
		formId: "block-39358caf2ef767205d99"
	},
	//demoday page
	{
		pageId: "collection-5912789e2e69cf5fef738724",
		formId: "block-3c35124a49ac82eb0bf5"
	}
];

var duplicatePages = pagesWithCustomButtons.slice(1);

/*Setup mock email form buttons to trigger true email forms*/
pagesWithCustomButtons.forEach(function(e){redirectCustomEmailForm(e.pageId, e.formId);});
// /* Homepage */
...
/* Remove redirect and add modal form functionality to all duplicate page sign up buttons */
duplicatePages.forEach(function(e){redirectSignUpButtons(e.pageId, e.formId);});
...
duplicatePages.forEach(function(e){$("#" + e.pageId + " .form-button-wrapper").append(privacyDisclaimerHtmlString);});
